...
%the function finds the p that gives exactly beta_component=beta_component_req
    ...
    parfor i_sim=1:input.N_sim
       ...
       myfun=@(pp_component) (component_beta_1yr_given_p_component( pp_component,input,i_sim ) - beta_component_req).^2; %pp_component = dummy variable
       ...
       a=pi/sqrt(6)/input.COV_Q_1yr(i_sim); u=1-0.577/a;
